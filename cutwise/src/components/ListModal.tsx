...
interface Props {
  ...
  updatePart: (
    partNumber: string,
    newState: Partial<Part> | Partial<Material>,
  ) => void;
  updateMaterialInArray: (
  ...
  return (
    <div className={styles.list__modal}>
      <div className={styles.modal__heading}>
        <h1>
          {props?.job ? props.job : "Job"} - {props.listName?.toUpperCase()}
        </h1>
      ...
      <div className={styles.list__modal__parts}>
        {props.listName === "parts"
          ? (props.list as Part[]).map((item: Part) => (
              <div
                key={item.PartNumber}
                className={styles.list__modal__parts__part}
              >
                <StyledInput
                  type="text"
                  ...
                  onChange={(e) =>
                    handlePartInputChange(e, item.PartNumber, "PartNumber")
                  }
                />
                <StyledInput
                  type="text"
                  ...
                  onChange={(e) =>
                    handlePartInputChange(e, item.PartNumber, "MaterialCode")
                  }
                />
                <StyledInput
                  type="number"
                  ...
                  value={item.Length}
                  onChange={(e) =>
                    handlePartInputChange(e, item.PartNumber, "Length")
                  }
                />
                <StyledInput
                  type="text"
                ...
                <StyledInput
                  ...
                  value={item.Quantity}
                  onChange={(e) =>
                    handlePartInputChange(e, item.PartNumber, "Quantity")
                  }
                />
          ...
          : (props.list as Material[]).map((item: Material, index: number) => (
              <div key={index} className={styles.list__modal__parts__part}>
                <StyledInput
                  type="text"
                  placeholder={item.MaterialCode}
                  value={item.MaterialCode}
                  onChange={(e) =>
                    handleMaterialInputChange(e, index, "MaterialCode")
                  }
                />
                <StyledInput
                  type="number"
                  ...
                  value={item.Length}
                  onChange={(e) =>
                    handleMaterialInputChange(e, index, "Length")
                  }
                />
                <StyledInput
                  type="number"
                  ...
                  value={item.Quantity}
                  onChange={(e) =>
                    handleMaterialInputChange(e, index, "Quantity")
                  }
                />
                ...
                <button
                  onClick={() => props.updateMaterialInArray(index, item)}
                >
                  <Save />
                </button>
              </div>
